    ...
    <div class="p-3 rounded-lg shadow">
        <form action="" method="post">
            <fieldset class="p-3 border">
                <legend class="font-weight-bold">Nouveau patient</legend>
                ...
                <div class="mt-3 w-100 d-flex justify-content-center">
                    <button class="btn btn-success font-weight-bold" type="submit" name="subscribe">Enregistrer</button>
                </div>
            </fieldset>
        </form>
    </div>
