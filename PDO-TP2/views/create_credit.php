...
<body class="bg-dark text-white">
    ...
    <div class="row justify-content-center" style="padding:10%;">
        <form action="" method="POST" class="col-md-6">
            ...
            <!-- Création d'une alerte en cas de succès de création d'un nouveau crédit. -->
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="client" id="client">
                    ...
                    <!-- Affichage du menu déroulant pour la liste des clients. -->
                    <?php foreach ($client_list as $client) { ?>
                    <option value="<?=$client->client_id?>"><?=$client->client_firstname.' '.$client->client_lastname?>
                    </option>
                    <?php } ?>
                </select>
            </div>
    ...
    <footer class="row p-3 mr-4 border m-auto justify-content-around mt-5">
        ...
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.378581301063!2d2.305869815570055!3d48.87005910783921!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66fc45b6fc7bf%3A0x83c587f7f4e0c0fc!2s36%20Av.%20des%20Champs-%C3%89lys%C3%A9es%2C%2075008%20Paris!5e0!3m2!1sfr!2sfr!4v1599202239533!5m2!1sfr!2sfr"
