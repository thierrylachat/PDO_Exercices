    ...
    <div class="row justify-content-center" style="padding:10%;">
        <form action="" method="POST" class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="address" name="address" placeholder="45 RUE DES FLANDRES"
                    value="<?= isset($_POST['address']) ? $_POST['address'] : ''; ?>">
            </div>
            <div class="form-group">
                <label for="zipcode">Code postal</label>
                <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="75000"
                    value="<?= isset($_POST['zipcode']) ? $_POST['zipcode'] : ''; ?>">
            </div>
            <div class="form-group">
                <label for="phone">Téléphone :</label>
                <input type="text" class="form-control" id="phone" name="phone" placeholder="0110203040"
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="statut_id" id="statut_id">
                    ...
                    <option value="<?= $statut->statut_id;?>"
                        <?= (isset($_POST['statut_id']) && $_POST['statut_id']==$statut->statut_id) ? 'selected' : '' ?>>
