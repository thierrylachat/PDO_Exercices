...
<body>
	<div class="container">
		...
		<div class="px-3">
			<a class="text-secondary" href="/index.php"><i class="mr-2 fas fa-arrow-left"></i>Retour</a>
		</div>
				...
				<fieldset class="p-3 border border-dark">
					...
					<div class="w-100 d-flex">
						<div class="mr-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['firstname']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Prénom</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="text" name="firstname" maxlenght="50"
						...
						<div class="ml-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['lastname']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Nom de famille</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="text" name="lastname" maxlenght="50"
					...
					<div class="mt-4 w-100 d-flex">
						<div class="mr-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['birthdate']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Date de naissance</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="date" name="birthdate"
					...
					<div class="mt-4 w-100">
						<div
							class="w-100 input-customized border <?= isset($errors['address']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
							<label class="px-1 small text-dark">Adresse</label>
							<input class="p-3 w-100 border-0 rounded-lg" type="text" name="address" maxlength="100"
								placeholder="Adresse (numéro + rue)" value="<?= isset($address) ? $address : ''; ?>">
						</div>
					...
					<div class="mt-4 w-100 d-flex">
						<div class="mr-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['zipcode']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Code postal</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="text" name="zipcode" maxlength="5"
						...
						<div class="ml-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['city']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Ville</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="text" name="city" maxlength="50"
					...
					<div class="mt-4 w-100 d-flex">
						<div class="mr-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['phone']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
								<label class="px-1 small text-dark">Numéro de téléphone</label>
								<input class="p-3 w-100 border-0 rounded-lg" type="text" name="phone" maxlength="20"
						...
						<div class="ml-3 w-100">
							<div
								class="w-100 input-customized border <?= isset($errors['service']) ? 'border-danger' : 'border-secondary'; ?> rounded-lg">
