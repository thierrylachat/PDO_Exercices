...
<div class="d-flex align-items-center">
        ...
        <?php if (isset($deleteSuccess)): ?>
            <div class="col-12" role="alert">
                <p>Le rendez-vous a été supprimé avec succès ! :)</p>
            </div>
        <?php else : ?>
            <h2 class="text-center text-dark">Etes vous sûr de vouloir supprimer le rendez-vous de <?= $fullName; ?> du <?= $dateHour; ?> ? </h2>
        <?php endif; ?>
