...
<head>
    ...
    <title>Informations personnelles de <?= $_GET['id']; ?></title>
</head>
...
<body>
    ...
    <div class="card">
        ...
        <a href="../controllers/liste_patients_ctrl.php">Retour à la liste des patients</a>
    </div>
    <?php else : ?>
    ...
    <div class="card col-md-6 m-auto mt-5" style="width: 30rem;background-color: rgba(74, 122, 233, 0.6) !important;">
        ...
        <?php } ?>
        <?php } else { ?>
        <p>Absence de rendez-vous programmé. </p>
        <?php }  ?>

        <a class="btn btn-secondary m-auto col-6 mb-2"
            href="modify_patients_ctrl.php?id=<?= $patientsView->id;?>">Modifier les informations du patient</a>
    </div>
