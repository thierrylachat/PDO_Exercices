            ...
            <div class="ml-5 container row m-auto">
                ...
                <div class="card mt-4 ml-4" style="width: 18rem;background-color: rgba(74, 122, 233, 0.6) !important;">
                    <div class="card-body text-center">
                        ...
                        <a class="btn btn-primary col-12 mb-2"
                            href="modify_appointment_ctrl.php?id=<?= $appointment->identifiant_app; ?>">Modifier le
                            rendez-vous</a>
                        <a class="btn btn-danger col-12 mb-2"
                            href="delete_appointment_ctrl.php?id=<?= $appointment->identifiant_app; ?>">Supprimer le
                            rendez-vous</a>
                    </div>
                </div>
                <?php } ?>
                <?php } else { ?>
                <h1 class="text-center">Aucun rendez-vous n'a été trouvé.
